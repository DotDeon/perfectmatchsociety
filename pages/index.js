...
export default function Home() {
  return (
    <div>
      ...
      <header className="hidden sticky bg-purple top-0 z-50 md:flex justify-between lg:px-36">
        ...
        <div className="flex items-center space-x-9 space-between text-white">
          ...
          <div className="lg:flex hidden relative flex-row md:space-x-8">
            ...
            <a
              target="_blank"
              href="https://www.discord.gg/pupsicles"
              rel="noopener noreferrer"
            >
              <svg
                width="32"
            ...
            <a
              target="_blank"
              href="https://twitter.com/pupsiclesnft"
              rel="noopener noreferrer"
            >
              <svg
                width="28"
      ...
      <div className=" justify-start items-start bg-purple min-h-screen min-w-screen">
        {/* Banner */}
        <div className="grid grid-cols-3 px-36 pt-20 items-start justify-start mb-20">
          <div className="col-span-2 mx-14 items-start -ml-10">
            <p className=" text-6xl font-bold mt-5">
              Welcome to the Perfect Match Society!
            </p>
            <p className="text-xl font-bold mt-12 mr-16">
            ...
            <div className="mt-10">
              <a className=" bg-black px-10 py-4 rounded-full text-white font-bold">
                {" "}
                MINT 0.01 ETH
              </a>
              <a className="text-black font-bold text-lg ml-12">
                {" "}
                10, 000/ 10, 000 left
              </a>
            </div>
        ...
        <div className="flex flex-col items-center mt-20">
          ...
          <div className=" w-1/2 h-[600px] bg-pink border-8 rounded-3xl border-white mt-6">
            <div className="container bg-gray-200 mx-auto w-full h-full">
              <div className="relative wrap overflow-hidden pt-10 px-10 h-full">
                <div className=" border-2-2 mt-12 absolute border-dashed border-2 border-black h-full ml-3"></div>

                <div className="mb-8 top-0 flex justify-between items-center w-full">
                  <div className="order-2 w-6/12"></div>
                  <div className="z-20">
                    <div className="h-7 w-7 bg-black rounded-full -mt-10"></div>
                  </div>
                  <div className="order-1 bg-gray-300 w-5/12 px-6 py-4">
                    <div className="flex flex-row">
                      <h3 className="mb-3 font-bold underline text-2xl">
                        Mint Phase
                      </h3>
                    </div>
                ...
                <div className="mb-8 top-0 flex justify-between items-center w-full">
                  ...
                  <div className="order-1 bg-gray-300 px-6 py-4">
                    <div className="flex flex-row">
                      <h3 className="mb-3 font-bold underline text-2xl">
                        Post Launch Phase
                      </h3>
